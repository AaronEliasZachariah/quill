    ...
    >
      <div className="flex items-center space-x-1">
        {isRecording ? (
          <div
            ref={shortcutRef}
            className="px-2.5 py-1 text-sm font-mono border border-logo-primary bg-logo-primary/12 text-logo-primary rounded-md"
          >
            {formatCurrentKeys()}
          </div>
        ) : (
          <div
            className="px-2.5 py-1 text-sm font-mono bg-mid-gray/10 border border-mid-gray/20 hover:bg-logo-primary/10 rounded-md cursor-pointer hover:border-logo-primary"
