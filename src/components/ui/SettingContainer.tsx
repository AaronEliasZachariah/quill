...
export const SettingContainer: React.FC<SettingContainerProps> = ({
  ...
  const containerClasses = grouped
    ? "px-4 p-2"
    : "px-4 p-2 rounded-card border border-mid-gray/12 bg-surface shadow-sheet";
  ...
  const horizontalContainerClasses = grouped
    ...
    : "flex items-center justify-between px-4 p-2 rounded-card border border-mid-gray/12 bg-surface shadow-sheet";
