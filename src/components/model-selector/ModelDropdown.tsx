...
const ModelDropdown: React.FC<ModelDropdownProps> = ({
  ...
  return (
    <div className="absolute bottom-full start-0 mb-2 w-64 max-h-[60vh] overflow-y-auto bg-surface border border-mid-gray/12 rounded-card shadow-sheet py-2 z-50">
